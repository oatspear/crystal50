...
; must switch turns to get the relative HP of the correct mon
	call SwitchTurnCore
; optimization: only two values, QUARTER_MAX_HP or EIGHTH_MAX_HP
	ld a, c
	cp QUARTER_MAX_HP
	jr nz, .recover_one_eighth
...
; From there, a 50% chance for Item2
	call BattleRandom
	cp 35 percent ; 35% of 45% = 15.75% Item2
	ld a, [wBaseItem1]
	jr nc, .UpdateItem
	ld a, [wBaseItem2]
