...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_HAPPY,     SUNKERN,    BULBASAUR,  "BULBASAUR@@", $ff, $ff, ORAN_BERRY,   00128, "OAK@@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_HAPPY,     LEDYBA,     CHARMANDER, "CHARMANDER@", $ff, $ff, ORAN_BERRY,   00128, "OAK@@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_HAPPY,     MARILL,     SQUIRTLE,   "SQUIRTLE@@@", $ff, $ff, ORAN_BERRY,   00128, "OAK@@@@@@@@", TRADE_GENDER_EITHER
