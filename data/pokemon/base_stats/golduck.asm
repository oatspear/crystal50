	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROCK_SMASH, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, IRON_TAIL, DIG, MUD_SLAP, ICE_PUNCH, REST, ATTRACT, FURY_CUTTER, WHIRLPOOL, ICE_BEAM
	; end
