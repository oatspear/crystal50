	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, SUNNY_DAY, SWEET_SCENT, HYPER_BEAM, PROTECT, GIGA_DRAIN, ENDURE, SOLARBEAM, DIG, ICE_PUNCH, SWIFT, THUNDERPUNCH, REST, ATTRACT, THIEF, FLASH
	; end
