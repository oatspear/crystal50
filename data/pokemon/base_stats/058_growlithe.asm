	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROAR, WILD_CHARGE, ROCK_SMASH, SUNNY_DAY, PLAY_ROUGH, PROTECT, ENDURE, DIG, FIRE_BLAST, REST, ATTRACT, THIEF, FACADE, IRON_TAIL, FLAMETHROWER, WILL_O_WISP
	; end
