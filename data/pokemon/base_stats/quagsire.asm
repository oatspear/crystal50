	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, ROCK_SMASH, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, HAIL, IRON_TAIL, EARTHQUAKE, DIG, MUD_SLAP, ICE_PUNCH, SLUDGE_BOMB, SANDSTORM, REST, ATTRACT, ICE_BEAM
	; end
