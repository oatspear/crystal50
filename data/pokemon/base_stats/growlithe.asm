	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROAR, ROCK_SMASH, SUNNY_DAY, PROTECT, ENDURE, IRON_TAIL, DRAGONBREATH, DIG, SLEEP_TALK, FIRE_BLAST, SWIFT, REST, ATTRACT, PLAY_ROUGH, FLAMETHROWER
	; end
