	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, ROCK_SMASH, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, GIGA_DRAIN, ENDURE, HAIL, SANDSTORM, REST, ATTRACT, THIEF, FURY_CUTTER, ICE_BEAM
	; end
