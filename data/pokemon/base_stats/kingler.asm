	...
	; tm/hm learnset
	tmhm CURSE, ROCK_SMASH, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, MUD_SLAP, SLEEP_TALK, REST, ATTRACT, THIEF, FURY_CUTTER, WHIRLPOOL, ICE_BEAM
	; end
