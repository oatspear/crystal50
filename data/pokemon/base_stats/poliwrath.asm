	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROCK_SMASH, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, EARTHQUAKE, PSYCHIC_M, MUD_SLAP, ICE_PUNCH, SWAGGER, SLEEP_TALK, REST, ATTRACT, THIEF, WHIRLPOOL, ICE_BEAM
	; end
