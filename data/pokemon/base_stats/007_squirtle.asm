	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, ROCK_SMASH, BLIZZARD, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, WATER_PULSE, DIG, SCALD, MUD_SLAP, ICE_PUNCH, IRON_DEFENSE, REST, ATTRACT, FACADE, IRON_TAIL, ICE_BEAM
	; end
