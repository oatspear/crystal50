	...
	; tm/hm learnset
	tmhm CURSE, ROCK_SMASH, BLIZZARD, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, REST, ATTRACT, THIEF, FURY_CUTTER, WHIRLPOOL, ICE_BEAM
	; end
