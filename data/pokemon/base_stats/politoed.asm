	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ROCK_SMASH, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, EARTHQUAKE, PSYCHIC_M, MUD_SLAP, ICE_PUNCH, REST, ATTRACT, THIEF, WHIRLPOOL, ICE_BEAM
	; end
