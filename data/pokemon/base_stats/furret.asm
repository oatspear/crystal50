	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, SUNNY_DAY, HYPER_BEAM, PROTECT, ENDURE, IRON_TAIL, DIG, SHADOW_BALL, MUD_SLAP, ICE_PUNCH, THUNDERPUNCH, REST, ATTRACT, THIEF, FIRE_PUNCH, FURY_CUTTER
	; end
