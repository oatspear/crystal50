	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, ROCK_SMASH, BLIZZARD, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, HAIL, IRON_TAIL, DIG, MUD_SLAP, ICE_PUNCH, SLEEP_TALK, REST, ATTRACT, WHIRLPOOL, ICE_BEAM
	; end
