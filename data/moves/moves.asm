...
; entries correspond to constants/move_constants.asm
	...
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           75, FIRE,          PHYSICAL, 100,              ENERGY_LEVEL_3,  30
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         75, ICE,           PHYSICAL, 100,              ENERGY_LEVEL_3,  30
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       75, ELECTRIC,      PHYSICAL, 100,              ENERGY_LEVEL_3,  30
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         75, FLYING,        SPECIAL,   95,              ENERGY_LEVEL_3,  30
	...
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         40, FLYING,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	...
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,      PHYSICAL, 100,              ENERGY_LEVEL_2,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move CLOSE_COMBAT, EFFECT_CLOSE_COMBAT,      100, FIGHTING,      PHYSICAL, 100,              ENERGY_LEVEL_4,   0
	move SUPERPOWER,   EFFECT_SUPERPOWER,        100, FIGHTING,      PHYSICAL, 100,              ENERGY_LEVEL_4,   0
	...
	move BODY_SLAM,    EFFECT_BODY_SLAM,          85, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_3,  30
	move WRAP,         EFFECT_TRAP_TARGET,        35, NORMAL,        PHYSICAL,  85,              ENERGY_LEVEL_2,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move DOUBLE_EDGE,  EFFECT_RECOIL_HIT,        100, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_4,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move POISON_STING, EFFECT_POISON_HIT,         30, POISON,        PHYSICAL, 100,              ENERGY_LEVEL_2,  50
	move POISON_JAB,   EFFECT_POISON_HIT,         80, POISON,        PHYSICAL, 100,              ENERGY_LEVEL_3,  30
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          25, BUG,           PHYSICAL,  95,              ENERGY_LEVEL_2,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move BITE,         EFFECT_FLINCH_HIT,         60, DARK,          PHYSICAL, 100,              ENERGY_LEVEL_2,  30
	move GROWL,        EFFECT_OFFENSES_DOWN,       0, NORMAL,        STATUS,   100,              ENERGY_LEVEL_2,   0
	move ROAR,         EFFECT_FORCE_SWITCH,        0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0
	move SING,         EFFECT_SLEEP,               0, NORMAL,        STATUS,    70,              ENERGY_LEVEL_2,   0
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,        STATUS,    70,              ENERGY_LEVEL_2,   0
	move BUG_BUZZ,     EFFECT_DEFENSES_DOWN_HIT,  80, BUG,           SPECIAL,  100,              ENERGY_LEVEL_3,  20
	...
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,          SPECIAL,  100,              ENERGY_LEVEL_2,  30
	move FLAMETHROWER, EFFECT_BURN_HIT,           80, FIRE,          SPECIAL,  100,              ENERGY_LEVEL_3,  20
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        100, WATER,         SPECIAL,   85,              ENERGY_LEVEL_4,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         80, ICE,           SPECIAL,  100,              ENERGY_LEVEL_3,  20
	move BLIZZARD,     EFFECT_BLIZZARD,          100, ICE,           SPECIAL,   75,              ENERGY_LEVEL_4,  30
	move NO_MOVE,      EFFECT_CONFUSE_HIT,         0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move BUBBLEBEAM,   EFFECT_SPEED_DOWN_HIT,     65, WATER,         SPECIAL,  100,              ENERGY_LEVEL_2,  30
	move AURORA_BEAM,  EFFECT_OFFENSES_DOWN_HIT,  65, ICE,           SPECIAL,  100,              ENERGY_LEVEL_2,  20
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        120, NORMAL,        SPECIAL,   90,              ENERGY_LEVEL_4,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	move LOW_SWEEP,    EFFECT_SPEED_DOWN_HIT,     65, FIGHTING,      PHYSICAL, 100,              ENERGY_LEVEL_3, 100
	...
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, NORMAL,        SPECIAL,  100,              ENERGY_LEVEL_2,   0
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,         STATUS,    90,              ENERGY_LEVEL_2,   0
	move GROWTH,       EFFECT_GROWTH,              0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         55, GRASS,         PHYSICAL,  95,              ENERGY_LEVEL_2,   0
	move SOLARBEAM,    EFFECT_SOLARBEAM,         100, GRASS,         SPECIAL,  100,              ENERGY_LEVEL_3,   0
	move POISONPOWDER, EFFECT_POISON,              0, POISON,        STATUS,    80,              ENERGY_LEVEL_2,   0
	move STUN_SPORE,   EFFECT_PARALYZE,            0, GRASS,         STATUS,    80,              ENERGY_LEVEL_2,   0
	move SLEEP_POWDER, EFFECT_SLEEP,               0, GRASS,         STATUS,    80,              ENERGY_LEVEL_2,   0
	move PETAL_DANCE,  EFFECT_RAMPAGE,           100, GRASS,         SPECIAL,  100,              ENERGY_LEVEL_3,   0
	move STRING_SHOT,  EFFECT_SPEED_DOWN,          0, BUG,           STATUS,   100,              ENERGY_LEVEL_1,   0
	move DRAGON_PULSE, EFFECT_NORMAL_HIT,         80, DRAGON,        SPECIAL,  PERFECT_ACCURACY, ENERGY_LEVEL_3,   0
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        35, FIRE,          SPECIAL,   85,              ENERGY_LEVEL_2,   0
	move THUNDERSHOCK, EFFECT_PARALYZE_HIT,       40, ELECTRIC,      SPECIAL,  100,              ENERGY_LEVEL_2,  30
	move THUNDERBOLT,  EFFECT_PARALYZE_HIT,       80, ELECTRIC,      SPECIAL,  100,              ENERGY_LEVEL_3,  20
	move THUNDER_WAVE, EFFECT_PARALYZE,            0, ELECTRIC,      STATUS,    90,              ENERGY_LEVEL_2,   0
	move THUNDER,      EFFECT_THUNDER,           100, ELECTRIC,      SPECIAL,   75,              ENERGY_LEVEL_4,  30
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         50, ROCK,          PHYSICAL,  90,              ENERGY_LEVEL_1,   0
	...
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE,  SPECIAL,  100,              ENERGY_LEVEL_2,  20
	move PSYCHIC_M,    EFFECT_DEFENSES_DOWN_HIT,  80, PSYCHIC_TYPE,  SPECIAL,  100,              ENERGY_LEVEL_3, 100
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_TYPE,  STATUS,    70,              ENERGY_LEVEL_2,   0
	move CALM_MIND,    EFFECT_PROWESS_UP,          0, PSYCHIC_TYPE,  STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_3,   0
	move AGILITY,      EFFECT_SPEED_UP_2,          0, PSYCHIC_TYPE,  STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_2,   0
	...
	move SCREECH,      EFFECT_DEFENSES_DOWN_2,     0, NORMAL,        STATUS,    85,              ENERGY_LEVEL_2,   0
	move DOUBLE_TEAM,  EFFECT_EVASION_UP,          0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0 ; FIXME
	move RECOVER,      EFFECT_HEAL,                0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_3,   0
	move HARDEN,       EFFECT_DEFENSES_UP_2,       0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0 ; FIXME
	move MINIMIZE,     EFFECT_EVASION_UP_2,        0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_3,   0 ; FIXME
	...
	move WITHDRAW,     EFFECT_DEFENSES_UP_2,       0, WATER,         STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0 ; FIXME
	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0 ; FIXME
	move DRAGON_DANCE, EFFECT_DRAGON_DANCE,        0, DRAGON,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0 ; FIXME
	move LIGHT_SCREEN, EFFECT_LIGHT_SCREEN,        0, PSYCHIC_TYPE,  STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_3,   0
	move HAZE,         EFFECT_RESET_STATS,         0, ICE,           STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_1,   0
	move REFLECT,      EFFECT_REFLECT,             0, PSYCHIC_TYPE,  STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_3,   0
	move FOCUS_ENERGY, EFFECT_FOCUS_ENERGY,        0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_2,   0
	...
	move SELFDESTRUCT, EFFECT_SELFDESTRUCT,      150, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_4,   0 ; FIXME
	move SEED_BOMB,    EFFECT_NORMAL_HIT,         80, GRASS,         PHYSICAL, 100,              ENERGY_LEVEL_2,   0 ; FIXME
	move LICK,         EFFECT_PARALYZE_HIT,       30, GHOST,         PHYSICAL, 100,              ENERGY_LEVEL_2,  30 ; FIXME
	move SMOG,         EFFECT_POISON_HIT,         30, POISON,        SPECIAL,  100,              ENERGY_LEVEL_2,  50
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,        SPECIAL,  100,              ENERGY_LEVEL_2,  30 ; FIXME
	move EARTH_POWER,  EFFECT_DEFENSES_DOWN_HIT,  80, GROUND,        SPECIAL,  100,              ENERGY_LEVEL_3,  20
	move FIRE_BLAST,   EFFECT_BURN_HIT,          100, FIRE,          SPECIAL,   85,              ENERGY_LEVEL_4,  20
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,         PHYSICAL, 100,              ENERGY_LEVEL_2,  20 ; FIXME
	...
	move SKULL_BASH,   EFFECT_SKULL_BASH,        100, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_3,   0
	move AVALANCHE,    EFFECT_REVENGE,            60, ICE,           PHYSICAL, 100,              ENERGY_LEVEL_3,   0
	move FLASH_CANNON, EFFECT_DEFENSES_DOWN_HIT,  80, STEEL,         SPECIAL,  100,              ENERGY_LEVEL_3,  20
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, PSYCHIC_TYPE,  STATUS,   100,              ENERGY_LEVEL_1,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, PSYCHIC_TYPE,  STATUS,   100,              ENERGY_LEVEL_1,   0
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,        STATUS,   PERFECT_ACCURACY, ENERGY_LEVEL_3,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         130, FIGHTING,      PHYSICAL,  85,              ENERGY_LEVEL_3,   0 ; FIXME
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,        STATUS,   100,              ENERGY_LEVEL_2,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC_TYPE,  SPECIAL,  100,              ENERGY_LEVEL_3,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        STATUS,    90,              ENERGY_LEVEL_2,   0
	move BRICK_BREAK,  EFFECT_BRICK_BREAK,        75, FIGHTING,      PHYSICAL, 100,              ENERGY_LEVEL_3,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          75, BUG,           PHYSICAL, 100,              ENERGY_LEVEL_3,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,        STATUS,    75,              ENERGY_LEVEL_2,   0
	move NO_MOVE,      EFFECT_NORMAL_HIT,          0, FLYING,        PHYSICAL, 100,              ENERGY_LEVEL_1,   0
	...
	move FACADE,       EFFECT_FACADE,             60, NORMAL,        PHYSICAL, 100,              ENERGY_LEVEL_3,   0
	move SPORE,        EFFECT_SLEEP,               0, GRASS,         STATUS,   100,              ENERGY_LEVEL_3,   0
