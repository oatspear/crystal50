...
; BattleTowerMons group 1
	...
	db ESPEON
	db LEFTOVERS
	db MUD_SLAP, PSYCHIC_M, MORNING_SUN, FUTURE_SIGHT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db SITRUS_BERRY
	db SHADOW_BALL, IRON_TAIL, BITE, MOONLIGHT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db CORSOLA
	db SCOPE_LENS
	db HYDRO_PUMP, EARTH_POWER, RECOVER, POWER_GEM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db LAPRAS
	db LUM_BERRY
	db BLIZZARD, HYDRO_PUMP, THUNDERBOLT, BODY_SLAM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db SNEASEL
	db SITRUS_BERRY
	db SLASH, SUCKER_PUNCH, NIGHT_SLASH, ICICLE_CRASH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db HOUNDOUR
	db SITRUS_BERRY
	db SUCKER_PUNCH, SOLARBEAM, ROAR, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db GIRAFARIG
	db KINGS_ROCK
	db PSYCHIC_M, CRUNCH, SHADOW_BALL, NASTY_PLOT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db BLISSEY
	db QUICK_CLAW
	db DISARMING_VOICE, SWEET_KISS, ROLLOUT, SOFTBOILED
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 32000
	...
	db SNORLAX
	db LUM_BERRY
	db HEADBUTT, PROTECT, BULLDOZE, CURSE
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db TAUROS
	db KINGS_ROCK
	db DOUBLE_EDGE, BULLDOZE, ZEN_HEADBUTT, SWAGGER
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MR__MIME
	db QUICK_CLAW
	db PSYCHIC_M, DAZZLING_GLEAM, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db STARMIE
	db SITRUS_BERRY
	db RECOVER, PSYCHIC_M, HYDRO_PUMP, THUNDERBOLT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db LUM_BERRY
	db DOUBLE_EDGE, EARTHQUAKE, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STEELIX
	db SITRUS_BERRY
	db ROAR, IRON_TAIL, EARTHQUAKE, SWAGGER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, RECOVER, REFLECT, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db SITRUS_BERRY
	db AGILITY, ROCK_SLIDE, EARTHQUAKE, AERIAL_ACE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db BLISSEY
	db BRIGHTPOWDER
	db CALM_MIND, DOUBLE_EDGE, SOFTBOILED, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PIKACHU
	db LIGHT_BALL
	db THUNDERBOLT, THUNDER_WAVE, QUICK_ATTACK, IRON_TAIL
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db AZUMARILL
	db MYSTIC_WATER
	db AQUA_TAIL, ICE_PUNCH, PLAY_ROUGH, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db MILTANK
	db KINGS_ROCK
	db EARTHQUAKE, BODY_SLAM, ATTRACT, BODY_SLAM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db WIGGLYTUFF
	db PINK_BOW
	db DISARMING_VOICE, SING, REST, DOUBLE_EDGE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db NIDOKING
	db ORAN_BERRY
	db BLIZZARD, EARTHQUAKE, POISON_JAB, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db QUAGSIRE
	db QUICK_CLAW
	db ICE_PUNCH, EARTHQUAKE, AQUA_TAIL, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db BELLY_DRUM, LIQUIDATION, EARTH_POWER, BRICK_BREAK
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db LEFTOVERS
	db THUNDER_WAVE, PSYCHIC_M, RECOVER, HYDRO_PUMP
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BELLOSSOM
	db BRIGHTPOWDER
	db GIGA_DRAIN, SUNNY_DAY, SOLARBEAM, SYNTHESIS
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db CROBAT
	db SITRUS_BERRY
	db ATTRACT, SUPERSONIC, TOXIC, ACROBATICS
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, DOUBLE_EDGE, HYPER_BEAM, BONEMERANG
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, WATER_PULSE, ICE_BEAM, BODY_SLAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LANTURN
	db SITRUS_BERRY
	db RAIN_DANCE, THUNDER, SCALD, ICE_BEAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ESPEON
	db LUM_BERRY
	db PSYCHIC_M, CHARM, CALM_MIND, SWIFT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db URSARING
	db SITRUS_BERRY
	db DOUBLE_EDGE, REST, NIGHT_SLASH, BULLDOZE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db FEAROW
	db BRIGHTPOWDER
	db FOCUS_ENERGY, DOUBLE_EDGE, DRILL_PECK, AGILITY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db PRIMEAPE
	db LUM_BERRY
	db LOW_SWEEP, REVENGE, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db TAUROS
	db SITRUS_BERRY
	db DOUBLE_EDGE, BODY_SLAM, EARTHQUAKE, IRON_TAIL
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KINGDRA
	db LEFTOVERS
	db SCALD, DRAGON_PULSE, DRAGON_DANCE, BLIZZARD
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LAPRAS
	db LEFTOVERS
	db THUNDERBOLT, ICE_BEAM, CONFUSE_RAY, HYDRO_PUMP
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db LEFTOVERS
	db BLIZZARD, THUNDERBOLT, SCALD, PSYCHIC_M
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db FOCUS_BAND
	db SELFDESTRUCT, EARTHQUAKE, BODY_SLAM, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SCIZOR
	db SCOPE_LENS
	db SLASH, STEEL_WING, FURY_CUTTER, SWORDS_DANCE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PORYGON2
	db LEFTOVERS
	db CONVERSION2, CONVERSION, TRI_ATTACK, RECOVER
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ARCANINE
	db CHARCOAL
	db FLARE_BLITZ, WILD_CHARGE, BODY_SLAM, ROAR
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, FLARE_BLITZ, AIR_SLASH, EARTHQUAKE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db SOLARBEAM, SYNTHESIS, SUNNY_DAY, PSYCHIC_M
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MUK
	db QUICK_CLAW
	db DISABLE, TOXIC, POISON_JAB, ACID_ARMOR
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db ELECTABUZZ
	db KINGS_ROCK
	db LIGHT_SCREEN, THUNDERPUNCH, FIRE_PUNCH, SWIFT
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 5
	...
	db KINGDRA
	db SITRUS_BERRY
	db SCALD, HYPER_BEAM, BLIZZARD, DRAGON_PULSE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SNORLAX
	db LEFTOVERS
	db GIGA_IMPACT, EARTHQUAKE, HEADBUTT, REST
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db LAPRAS
	db SITRUS_BERRY
	db THUNDERBOLT, WATER_PULSE, REST, BLIZZARD
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db JOLTEON
	db KINGS_ROCK
	db THUNDERBOLT, THUNDER_WAVE, SHADOW_BALL, BITE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SLOWKING
	db CHESTO_BERRY
	db REST, SCALD, PSYCHIC_M, CALM_MIND
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db SCOPE_LENS
	db THUNDER_WAVE, RECOVER, THUNDERBOLT, WATER_PULSE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SKARMORY
	db SITRUS_BERRY
	db SANDSTORM, DRILL_PECK, STEEL_WING, SPIKES
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db FORRETRESS
	db LEFTOVERS
	db SANDSTORM, TOXIC, SELFDESTRUCT, BUG_BITE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db LUM_BERRY
	db GIGA_IMPACT, LIQUIDATION, RAIN_DANCE, ICE_FANG
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db KINGDRA
	db LEFTOVERS
	db DRAGONBREATH, HYDRO_PUMP, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db DRAGONITE
	db LUM_BERRY
	db HYPER_BEAM, ICE_BEAM, THUNDERBOLT, OUTRAGE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db UMBREON
	db SITRUS_BERRY
	db MUD_SLAP, MOONLIGHT, PSYCHIC_M, BITE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SKARMORY
	db LUM_BERRY
	db STEEL_WING, DRILL_PECK, SANDSTORM, PROTECT
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SNORLAX
	db PINK_BOW
	db ROCK_SLIDE, REST, BODY_SLAM, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BLASTOISE
	db SITRUS_BERRY
	db HYDRO_PUMP, EARTHQUAKE, RAPID_SPIN, BLIZZARD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db RHYDON
	db QUICK_CLAW
	db EARTHQUAKE, AVALANCHE, IRON_TAIL, ROCK_SLIDE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SANDSLASH
	db SCOPE_LENS
	db EARTHQUAKE, SLASH, SANDSTORM, X_SCISSOR
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db GOLEM
	db BRIGHTPOWDER
	db SELFDESTRUCT, EARTHQUAKE, FIRE_PUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db VAPOREON
	db LEFTOVERS
	db BLIZZARD, CALM_MIND, SCALD, MUD_SLAP
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db UMBREON
	db SITRUS_BERRY
	db BITE, MOONLIGHT, CALM_MIND, SNARL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db HOUNDOOM
	db KINGS_ROCK
	db CRUNCH, FLAMETHROWER, SUCKER_PUNCH, ROAR
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 58000
	...
	db UMBREON
	db SITRUS_BERRY
	db MOONLIGHT, BITE, PSYCHIC_M, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db BRIGHTPOWDER
	db LIQUIDATION, EARTHQUAKE, CRUNCH, DRAGON_DANCE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db QUAGSIRE
	db LUM_BERRY
	db EARTHQUAKE, AQUA_TAIL, SLUDGE_BOMB, IRON_TAIL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GIRAFARIG
	db SITRUS_BERRY
	db NASTY_PLOT, PSYCHIC_M, CRUNCH, EARTHQUAKE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HITMONLEE
	db FOCUS_BAND
	db REVERSAL, ENDURE, BODY_SLAM, BRICK_BREAK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db SNORLAX
	db LEFTOVERS
	db REST, BODY_SLAM, GIGA_IMPACT, EARTHQUAKE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db LAPRAS
	db CHESTO_BERRY
	db REST, WATER_PULSE, ICE_BEAM, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db FORRETRESS
	db LEFTOVERS
	db SELFDESTRUCT, TOXIC, RAPID_SPIN, PROTECT
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db KINGDRA
	db CHESTO_BERRY
	db REST, HYDRO_PUMP, BLIZZARD, DRAGONBREATH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db DRAGONITE
	db SITRUS_BERRY
	db THUNDER_WAVE, ICE_BEAM, THUNDERBOLT, OUTRAGE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MANTINE
	db SITRUS_BERRY
	db WATER_PULSE, REST, BLIZZARD, AIR_SLASH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db SKARMORY
	db QUICK_CLAW
	db STEEL_WING, DRILL_PECK, MUD_SLAP, WHIRLWIND
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MOLTRES
	db CHARCOAL
	db FLAMETHROWER, DRILL_PECK, ROOST, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ELECTRODE
	db KINGS_ROCK
	db THUNDERBOLT, SELFDESTRUCT, MIRROR_COAT, SCREECH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PINSIR
	db SITRUS_BERRY
	db GIGA_IMPACT, BRICK_BREAK, BUG_BITE, SWORDS_DANCE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db UMBREON
	db KINGS_ROCK
	db BITE, MUD_SLAP, MOONLIGHT, CONFUSE_RAY
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db STARMIE
	db LEFTOVERS
	db RECOVER, THUNDERBOLT, WATER_PULSE, PSYCHIC_M
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db CLOYSTER
	db LEFTOVERS
	db SELFDESTRUCT, ICICLE_CRASH, LIQUIDATION, ICE_SHARD
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CROBAT
	db SITRUS_BERRY
	db ACROBATICS, HAZE, SUPER_FANG, LEECH_LIFE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KINGDRA
	db LEFTOVERS
	db DRAGON_PULSE, SCALD, DRAGON_DANCE, ICE_BEAM
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LAPRAS
	db CHESTO_BERRY
	db REST, WATER_PULSE, BODY_SLAM, ICE_BEAM
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, DOUBLE_EDGE, BULK_UP, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SNORLAX
	db LUM_BERRY
	db REST, BODY_SLAM, EARTHQUAKE, DOUBLE_EDGE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, TOXIC, DRILL_PECK
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 10
	...
	db MACHAMP
	db QUICK_CLAW
	db REVENGE, EARTHQUAKE, BULK_UP, CLOSE_COMBAT
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db KINGDRA
	db LEFTOVERS
	db HYDRO_PUMP, DRAGONBREATH, REST, RAIN_DANCE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db RHYDON
	db LUM_BERRY
	db AVALANCHE, EARTHQUAKE, REST, ROCK_SLIDE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db STEELIX
	db LEFTOVERS
	db EARTHQUAKE, DOUBLE_EDGE, CRUNCH, SWAGGER
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SNEASEL
	db SCOPE_LENS
	db SLASH, BLIZZARD, DREAM_EATER, SUCKER_PUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db OMASTAR
	db LEFTOVERS
	db HYDRO_PUMP, ANCIENTPOWER, BLIZZARD, REST
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LANTURN
	db QUICK_CLAW
	db WATER_PULSE, RAIN_DANCE, THUNDER, CONFUSE_RAY
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 30000
