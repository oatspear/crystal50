...
; ANIM_OBJ_SAND_TOMB
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_6F, BATTLEANIMFUNC_SMOKE_FLAME_WHEEL, PAL_BATTLE_OB_BROWN, ANIM_GFX_HAZE
; ANIM_OBJ_LEECH_SEED
...
; ANIM_OBJ_INFESTATION
	battleanimobj RELATIVE_X | X_FLIP, $68, BATTLEANIMFRAMESET_89, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_GREEN, ANIM_GFX_MISC
; ANIM_OBJ_BIG_AVALANCHE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS
; ANIM_OBJ_SMALL_AVALANCHE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS
