...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   DISARMING_VOICE, MIMIC, ENCORE, METRONOME
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, LIGHT_SCREEN, THUNDER_WAVE
	db 30, MAGNETON,   THUNDERBOLT, SUPERSONIC, TRI_ATTACK, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, CROSS_CHOP, REVENGE, FURY_SWIPES
