...
Rival1Group:
	...
	db 30, HAUNTER,    NIGHT_SHADE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    BEAT_UP, QUICK_ATTACK, SCREECH, BITE
	db 32, FERALIGATR, FLAIL, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
...
KogaGroup:
	...
	db 40, ARIADOS,    DOUBLE_TEAM, INFESTATION, BATON_PASS, GIGA_DRAIN
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, EMBER, SMOKESCREEN, SLASH, SCARY_FACE
	...
	db 27, CHARMELEON, EMBER, SMOKESCREEN, SLASH, SCARY_FACE
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, CRUNCH, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, STRENGTH, LOW_SWEEP, FOCUS_ENERGY
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, VILEPLUME,  ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID_SPRAY
	db 32, MURKROW,    PECK, DARK_PULSE, HAZE, NIGHT_SHADE
	db -1 ; end
...
RedGroup:
	...
	db 75, SNORLAX,    AMNESIA, EARTHQUAKE, REST, BODY_SLAM
