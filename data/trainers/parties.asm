...
FalknerGroup:
	...
	db 12, HOOTHOOT,   LUM_BERRY,     PECK, CONFUSION, REFLECT, ROOST
	db 12, DODUO,      ORAN_BERRY,    PECK, FURY_ATTACK, GROWL, ROOST
...
WhitneyGroup:
	...
	db 22, MILTANK,    SITRUS_BERRY,  ROLLOUT, ATTRACT, STOMP, HEAL_BELL
	db -1 ; end
...
PryceGroup:
	...
	db 31, SNEASEL,    ORAN_BERRY,    ICE_PUNCH, DIG, LOW_SWEEP, LEER
...
Rival1Group:
	...
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, BITE
...
BrockGroup:
	...
	db 41, GRAVELER,   IRON_DEFENSE, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, BITE
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, BITE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, POISON_STING, FURY_CUTTER
	...
	db 32, BEEDRILL,   FURY_ATTACK, FURY_CUTTER, POISON_JAB, DOUBLE_TEAM
...
SwimmerFGroup:
	...
	db 21, HORSEA,     DRAGONBREATH, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 25, MACHOP,     LEER, FOCUS_ENERGY, REVENGE, SEISMIC_TOSS
	db 25, MACHOKE,    LEER, REVENGE, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 25, MURKROW,    PECK, DARK_PULSE, HAZE, NO_MOVE
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, AERIAL_ACE, AIR_SLASH
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, SEED_BOMB, SOLARBEAM
