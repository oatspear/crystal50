...
CooltrainerMGroup:
	...
	db 37, DRAGONAIR,  WRAP, SURF, TWISTER, SLAM
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     METAL_CLAW, LEER, VICEGRIP, HARDEN
...
HikerGroup:
	...
	db 35, DUGTRIO,    BULLDOZE, DIG, MUD_SLAP, SLASH
...
TwinsGroup:
	...
	db 16, JIGGLYPUFF, SING, CHARM, POUND, DISABLE
	db -1 ; end
