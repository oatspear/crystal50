...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, RAGE, REVENGE, FURY_SWIPES
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, POISON_STING, RAGE
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, STRENGTH, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
