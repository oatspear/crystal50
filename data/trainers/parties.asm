...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, DEFENSE_CURL, SOFTBOILED
	db -1 ; end
...
HikerGroup:
	...
	db 34, GRAVELER,   BULLDOZE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 36, GOLEM,      BULLDOZE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
