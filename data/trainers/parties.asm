...
BugsyGroup:
	...
	db 15, YANMA,      LUM_BERRY,     AERIAL_ACE, DETECT, QUICK_ATTACK, DOUBLE_TEAM
	db 15, BEEDRILL,   ORAN_BERRY,    POISON_STING, STRING_SHOT, FURY_CUTTER, ROOST
	db 18, SCYTHER,    SITRUS_BERRY,  QUICK_ATTACK, WING_ATTACK, FURY_CUTTER, DOUBLE_TEAM
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONTOP,  RAPID_SPIN, QUICK_ATTACK, DIG, DETECT
	...
	db 46, MACHAMP,    ROCK_SLIDE, EARTHQUAKE, VITAL_THROW, CROSS_CHOP
	db -1 ; end
...
HikerGroup:
	...
	db 34, MACHOKE,    REVENGE, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
