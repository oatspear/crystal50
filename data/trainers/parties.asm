...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   FAIRY_VOICE, MIMIC, ENCORE, METRONOME
...
WillGroup:
	...
	db 42, XATU,       QUICK_ATTACK, DAZZLE_GLEAM, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
MistyGroup:
	...
	db 47, STARMIE,    SURF, DAZZLE_GLEAM, RECOVER, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 44, RAICHU,     THUNDER_WAVE, QUICK_ATTACK, PLAY_ROUGH, THUNDER
...
ErikaGroup:
	...
	db 41, JUMPLUFF,   DAZZLE_GLEAM, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 46, VICTREEBEL, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 46, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, DAZZLE_GLEAM, SOLARBEAM
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, MR__MIME,   DAZZLE_GLEAM, REFLECT, BATON_PASS, PSYCHIC_M
	db 48, ALAKAZAM,   RECOVER, DAZZLE_GLEAM, PSYCHIC_M, REFLECT
	db -1 ; end
...
BlaineGroup:
	...
	db 50, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, PLAY_ROUGH, FIRE_BLAST
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, FAIRY_VOICE, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, FAIRY_VOICE, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, FAIRY_VOICE, MINIMIZE
	db -1 ; end
...
TwinsGroup:
	...
	db 16, CLEFAIRY,   GROWL, ENCORE, FAIRY_VOICE, METRONOME
	db 16, JIGGLYPUFF, SING, DEFENSE_CURL, FAIRY_VOICE, DISABLE
	db -1 ; end
...
RedGroup:
	...
	db 73, ESPEON,     DAZZLE_GLEAM, REFLECT, SWIFT, PSYCHIC_M
...
BlueGroup:
	...
	db 54, ALAKAZAM,   DAZZLE_GLEAM, RECOVER, PSYCHIC_M, REFLECT
	...
	db 58, ARCANINE,   ROAR, PLAY_ROUGH, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
