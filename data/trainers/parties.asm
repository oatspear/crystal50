...
PryceGroup:
	...
	db 31, SNEASEL,    ORAN_BERRY,    ICE_PUNCH, DIG, LOW_SWEEP, BEAT_UP
	db 33, LAPRAS,     LUM_BERRY,     HAIL, SURF, AVALANCHE, REST
...
ChuckGroup:
	...
	db 25, HITMONTOP,  LUM_BERRY,     RAPID_SPIN, TRIPLE_KICK, SUCKER_PUNCH, BULLDOZE
	db 28, PRIMEAPE,   ORAN_BERRY,    SWAGGER, CROSS_CHOP, BULLDOZE, PAYBACK
	db 31, POLIWRATH,  SITRUS_BERRY,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
CamperGroup:
	...
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, BULLDOZE
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, BULLDOZE
