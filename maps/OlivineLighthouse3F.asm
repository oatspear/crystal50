...
OlivineLighthouse3FMoomooMilk:
	itemball MOOMOO_MILK
...
OlivineLighthouse3F_MapEvents:
	...
	object_event  8,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, OlivineLighthouse3FMoomooMilk, EVENT_OLIVINE_LIGHTHOUSE_3F_MOOMOO_MILK
