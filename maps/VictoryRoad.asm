...
VictoryRoad_MapEvents:
	...
	object_event  7, 38, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VictoryRoadStarPiece, EVENT_VICTORY_ROAD_STAR_PIECE
