...
UnionCaveB1F_MapEvents:
	...
	object_event  2, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, UnionCaveB1FTMMudSlap, EVENT_UNION_CAVE_B1F_TM_MUD_SLAP
