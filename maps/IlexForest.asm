...
IlexForest_MapEvents:
	...
	warp_event 29, 18, ILEX_FOREST_WILD_AREA, 1
	warp_event 29, 19, ILEX_FOREST_WILD_AREA, 2
	...
	object_event 27,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IlexForestSitrusBerry, EVENT_ILEX_FOREST_SITRUS_BERRY
