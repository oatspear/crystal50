...
MountMortarB1FMaxElixer:
	itemball MAX_ELIXER

MountMortarB1FPotassium:
	itemball POTASSIUM
...
MountMortarB1F_MapEvents:
	...
	object_event 32,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FMaxElixer, EVENT_MOUNT_MORTAR_B1F_MAX_ELIXER
	object_event 21, 26, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FPotassium, EVENT_MOUNT_MORTAR_B1F_POTASSIUM
