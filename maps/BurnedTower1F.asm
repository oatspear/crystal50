...
BurnedTower1FHiddenStardust:
	hiddenitem STARDUST, EVENT_BURNED_TOWER_1F_HIDDEN_STARDUST

BurnedTower1FHiddenUltraBall:
	hiddenitem ULTRA_BALL, EVENT_BURNED_TOWER_1F_HIDDEN_ULTRA_BALL

BurnedTower1FTM39Payback:
	itemball TM_PAYBACK
...
BurnedTower1F_MapEvents:
	...
	def_bg_events
	bg_event  8,  7, BGEVENT_ITEM, BurnedTower1FHiddenStardust
	...
	object_event 14,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, BurnedTower1FTM39Payback, EVENT_BURNED_TOWER_1F_TM_PAYBACK
