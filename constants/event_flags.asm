...
; Johto Gym Leader HM gifts
	const EVENT_GOT_HM01_ROOST
	const EVENT_GOT_HM02_FURY_CUTTER
	const EVENT_GOT_HM03_FACADE
	const EVENT_GOT_HM04_SHADOW_BALL
	const EVENT_GOT_HM05_BRICK_BREAK
	const EVENT_GOT_HM06_IRON_TAIL
	const EVENT_GOT_HM07_AVALANCHE
	const EVENT_GOT_HM08_DRAGONBREATH
; Rods
...
; Johto story events
	...
	const EVENT_GOT_TM49_FALSE_SWIPE
	...
	const EVENT_GOT_TM13_PLAY_ROUGH_FROM_MOOMOO_FARM
	...
	const EVENT_GOT_TM_AERIAL_ACE_FROM_RANDY
	...
	const EVENT_GOT_TM24_ENERGY_BALL
	const EVENT_GOT_TM36_SLUDGE_BOMB
	const EVENT_GOT_ITEMFINDER
	const EVENT_GOT_BICYCLE
	const EVENT_GOT_SQUIRTBOTTLE
	const EVENT_GOT_MIRACLE_SEED_IN_SPROUT_TOWER
	const EVENT_GOT_SHARP_BEAK_IN_ROUTE_32
	...
	const EVENT_GOT_TM23_WATER_PULSE
	const EVENT_GOT_TM15_HYPER_BEAM  ; NOTE: probably not needed
	const EVENT_GOT_MOON_STONE_IN_DANCE_THEATRE
; Johto hidden items
	const EVENT_TIN_TOWER_4F_HIDDEN_MAX_POTION
	const EVENT_TIN_TOWER_5F_HIDDEN_FULL_RESTORE
	const EVENT_TIN_TOWER_5F_HIDDEN_CARBOS
	const EVENT_BURNED_TOWER_1F_HIDDEN_STARDUST
	...
	const EVENT_ILEX_FOREST_HIDDEN_SILVERPOWDER
	...
	const EVENT_CIANWOOD_CITY_HIDDEN_ELIXER
...
; events added later for backward compatibility
	const EVENT_ILEX_FOREST_WILD_AREA_HIDDEN_BRIGHTPOWDER
	const EVENT_ILEX_FOREST_WILD_AREA_HIDDEN_POISON_BARB
	const EVENT_ILEX_FOREST_WILD_AREA_HIDDEN_LIFE_HERB
	const EVENT_ILEX_FOREST_WILD_AREA_HIDDEN_NUGGET
...
; Kanto story events
	...
	const EVENT_GOT_NUGGET_FROM_VERMILION_GUY
...
; Kanto hidden items
	...
	const EVENT_ROUTE_2_HIDDEN_BERRY_JUICE
	...
	const EVENT_CELADON_CITY_HIDDEN_RARE_CANDY
	const EVENT_CINNABAR_ISLAND_HIDDEN_RARE_CANDY
	const EVENT_BURNED_TOWER_1F_HIDDEN_ULTRA_BALL
	const EVENT_VIRIDIAN_FOREST_HIDDEN_SILVERPOWDER
	const EVENT_VIRIDIAN_FOREST_HIDDEN_MIRACLE_SEED
	const EVENT_VIRIDIAN_FOREST_HIDDEN_POISON_BARB
; Gift items
...
; Phone events
	...
	const EVENT_GOT_TM_HYPER_BEAM_FROM_JOEY
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_JOEY_TM_HYPER_BEAM
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_MANUEL
; Officer
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_JOANA
; ExecutiveF
...
; Super Nerd
	...
	const EVENT_BEAT_SUPER_NERD_HORTON
; Medium
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_FIREBREATHER_KAI
	const EVENT_BEAT_BLACKBELT_DAISUKE
	const EVENT_BEAT_COOLTRAINERF_FLORA
	const EVENT_BEAT_COOLTRAINERM_VICTOR
...
; Johto itemballs
	...
	const EVENT_VIOLET_CITY_SHARP_BEAK
	const EVENT_VIOLET_CITY_RARE_CANDY
	const EVENT_LAKE_OF_RAGE_ELIXER
	const EVENT_LAKE_OF_RAGE_TM_RAIN_DANCE
	...
	const EVENT_TIN_TOWER_4F_FAST_BALL
	...
	const EVENT_BURNED_TOWER_1F_TM_PAYBACK
	...
	const EVENT_UNION_CAVE_B1F_TM_MUD_SLAP
	...
	const EVENT_OLIVINE_LIGHTHOUSE_3F_MOOMOO_MILK
	const EVENT_OLIVINE_LIGHTHOUSE_5F_RARE_CANDY
	const EVENT_OLIVINE_LIGHTHOUSE_5F_SUPER_REPEL
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_DAZZLING_GLEAM
	...
	const EVENT_GOLDENROD_DEPT_STORE_B1F_BLACKBELT_I
	...
	const EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_MAX_ELIXER
	const EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_TM_X_SCISSOR
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_POTASSIUM
	...
	const EVENT_MOUNT_MORTAR_2F_INSIDE_TM_IRON_DEFENSE
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_PLAY_ROUGH
	...
	const EVENT_VICTORY_ROAD_STAR_PIECE
	...
	const EVENT_ROUTE_43_SCOPE_LENS
...
; Kanto people
	...
	const EVENT_VIRIDIAN_FOREST_BULBASAUR
; Kanto itemballs
	...
	const EVENT_ROCK_TUNNEL_B1F_TM32_BULLDOZE
	...
	const EVENT_ROUTE_4_BIG_MUSHROOM
	const EVENT_ROUTE_12_CALCIUM
	const EVENT_ROUTE_12_NUGGET
	const EVENT_ROUTE_15_TM36_SLUDGE_BOMB
	const EVENT_ROUTE_25_PROTEIN
	const EVENT_VIRIDIAN_FOREST_FULL_HEAL
	const EVENT_VIRIDIAN_FOREST_MAX_POTION
	const EVENT_VIRIDIAN_FOREST_CARBOS
...
; New to Crystal
	...
	const EVENT_ILEX_FOREST_SITRUS_BERRY
	...
	const EVENT_SILVER_CAVE_ROOM_2_POTASSIUM
	const EVENT_TIN_TOWER_1F_WISE_TRIO_2
	const EVENT_TIN_TOWER_6F_MAX_POTION
	const EVENT_TIN_TOWER_9F_SACRED_ASH
	...
	const EVENT_MOUNT_MORTAR_B1F_MAX_ELIXER
	const EVENT_MOUNT_MORTAR_B1F_POTASSIUM
	...
	const EVENT_ILEX_FOREST_WILD_AREA_LEAF_STONE
	const EVENT_ILEX_FOREST_WILD_AREA_LEFTOVERS
	const EVENT_ILEX_FOREST_WILD_AREA_HEAVY_BALL
	const EVENT_ILEX_FOREST_WILD_AREA_URSARING
