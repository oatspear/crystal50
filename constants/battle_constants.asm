...
ENERGY_20_MOVES EQU 1
ENERGY_10_MOVES EQU 2
ENERGY_5_MOVES  EQU 4
ENERGY_2_MOVES  EQU 8

LOWEST_MOVE_ENERGY  EQU ENERGY_20_MOVES
HIGHEST_MOVE_ENERGY EQU ENERGY_2_MOVES

; ENERGY_RECOVERY_IN_BATTLE   EQU 1
; ENERGY_RECOVERY_IN_PARTY    EQU 10
; ENERGY_RECOVERY_SLEEP_BONUS EQS "* 2"
; ENERGY_RECOVERY_POISON_PENALTY EQS "/ 2"
ENERGY_RECOVERY_LEPPA_BERRY EQU (MAX_ENERGY / 2)
ENERGY_TRIGGER_LEPPA_BERRY EQU (MAX_ENERGY / 4) + 1
ENERGY_RECOVERY_ELIXIR EQU (MAX_ENERGY / 2)
ENERGY_DRAIN_SPITE EQU ENERGY_5_MOVES
