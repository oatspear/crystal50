...
ENERGY_LEVEL_1 EQU 1
ENERGY_LEVEL_2 EQU 2
ENERGY_LEVEL_3 EQU 4
ENERGY_LEVEL_4 EQU 8
ENERGY_LEVEL_5 EQU 12

MIMIC_MOVE_ENERGY       EQU ENERGY_LEVEL_4
TRANSFORMED_MOVE_ENERGY EQU ENERGY_LEVEL_3 ; assuming only Ditto

ENERGY_TRIGGER_LEPPA_BERRY  EQU ENERGY_LEVEL_4 + 1
ENERGY_RECOVERY_LEPPA_BERRY EQU ENERGY_LEVEL_5
ENERGY_RECOVERY_ELIXER      EQU ENERGY_LEVEL_5 * 2
ENERGY_RECOVERY_SLP         EQU ENERGY_LEVEL_4
ENERGY_DRAIN_SPITE          EQU ENERGY_LEVEL_4
ENERGY_DRAIN_PSN            EQU 1
