...
DEF MIN_LEVEL EQU 2
DEF EGG_LEVEL EQU 2
DEF LEVEL_EVO EQU 101 ; EVOLVE_LEVEL might have worked, but just to separate things
...
DEF ENERGY_30_PP EQU 1
DEF ENERGY_20_PP EQU 2
DEF ENERGY_15_PP EQU 3
DEF ENERGY_10_PP EQU 4
DEF ENERGY_8_PP  EQU 5
DEF ENERGY_7_PP  EQU 6
DEF ENERGY_6_PP  EQU 7
DEF ENERGY_5_PP  EQU 8

DEF MIMIC_MOVE_ENERGY       EQU ENERGY_10_PP
DEF TRANSFORMED_MOVE_ENERGY EQU ENERGY_10_PP ; assuming only Ditto

DEF ENERGY_TRIGGER_LEPPA_BERRY  EQU ENERGY_5_PP + 1
DEF ENERGY_RECOVERY_LEPPA_BERRY EQU ENERGY_5_PP + ENERGY_10_PP
DEF ENERGY_RECOVERY_ELIXER      EQU ENERGY_5_PP * 3
DEF ENERGY_RECOVERY_SLP         EQU ENERGY_10_PP
DEF ENERGY_RECOVERY_FOCUS       EQU ENERGY_30_PP
DEF ENERGY_DRAIN_SPITE          EQU ENERGY_15_PP
DEF ENERGY_DRAIN_PSN            EQU ENERGY_30_PP
DEF ENERGY_DRAIN_ENDURE         EQU ENERGY_10_PP

; assert ENERGY_TRIGGER_LEPPA_BERRY + ENERGY_RECOVERY_LEPPA_BERRY < MAX_ENERGY

DEF RAMPAGE_FIRST_TURN EQU %10000000
DEF RAMPAGE_COUNTER_MASK EQU %00000011
DEF RAMPAGE_POWER_BOOST EQU 20

; significant stat values
DEF MIN_STAT_LEVEL  EQU 1  ; -1
DEF BASE_STAT_LEVEL EQU 2  ; +0
DEF MAX_STAT_LEVEL  EQU 3  ; +1
...
DEF STAT_LEVEL_DEFAULT_DURATION EQU 3
DEF STAT_LEVEL_EXTEND_1_TURN    EQU $10
DEF STAT_LEVEL_EXTEND_2_TURNS   EQU $20
...
DEF BASE_PRIORITY EQU PRIORITY_0
...
DEF STATUS_TURN_COUNTER EQU %11 ; 0-3 turns
DEF SLP_BIT EQU %100
...
DEF ANY_STATUS EQU (1 << PSN) | (1 << BRN) | (1 << FRZ) | (1 << PAR) | SLP_BIT
DEF FRZ_TURNS_MASK EQU (1 << FRZ) | STATUS_TURN_COUNTER
...
DEF SCREENS_SPIKES_MASK EQU (1 << SCREENS_SPIKES) | (1 << SCREENS_SPIKES2)
DEF SPIKES_1_LAYER  EQU (1 << SCREENS_SPIKES)
DEF SPIKES_2_LAYERS EQU (1 << SCREENS_SPIKES2)
DEF SPIKES_3_LAYERS EQU SPIKES_1_LAYER | SPIKES_2_LAYERS
...
DEF THIS_TURN_PLAYER_TOOK_DAMAGE           EQU %00000001
DEF THIS_TURN_PLAYER_TOOK_DIRECT_DAMAGE    EQU %00000010
DEF THIS_TURN_ENEMY_TOOK_DAMAGE            EQU %00010000
DEF THIS_TURN_ENEMY_TOOK_DIRECT_DAMAGE     EQU %00100000
