...
ENERGY_25_MOVES EQU  4
ENERGY_16_MOVES EQU  6
ENERGY_10_MOVES EQU 10
ENERGY_8_MOVES  EQU 12
ENERGY_5_MOVES  EQU 20

LOWEST_MOVE_ENERGY  EQU ENERGY_25_MOVES
HIGHEST_MOVE_ENERGY EQU ENERGY_5_MOVES
...
ENERGY_TRIGGER_LEPPA_BERRY EQU ENERGY_5_MOVES + 1
