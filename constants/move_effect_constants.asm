; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_ROOST
	const EFFECT_OFFENSES_UP  ; EFFECT_ATTACK_UP
	const EFFECT_DEFENSES_UP  ; EFFECT_DEFENSE_UP
	const EFFECT_SPEED_UP
	const EFFECT_PROWESS_UP   ; EFFECT_SP_ATK_UP
	const_skip  ; EFFECT_SP_DEF_UP
	const EFFECT_ACCURACY_UP
	const EFFECT_EVASION_UP
	const EFFECT_OFFENSES_DOWN  ; EFFECT_ATTACK_DOWN
	const EFFECT_DEFENSES_DOWN  ; EFFECT_DEFENSE_DOWN
	const EFFECT_SPEED_DOWN
	const_skip  ; EFFECT_SP_ATK_DOWN
	const_skip  ; EFFECT_SP_DEF_DOWN
	...
	const EFFECT_GROWTH
	const EFFECT_FRZ_FLINCH_HIT
	const EFFECT_PAR_FLINCH_HIT
	...
	const EFFECT_OFFENSES_UP_2  ; EFFECT_ATTACK_UP_2
	const EFFECT_DEFENSES_UP_2  ; EFFECT_DEFENSE_UP_2
	const EFFECT_SPEED_UP_2
	const_skip  ; EFFECT_SP_ATK_UP_2
	const_skip  ; EFFECT_SP_DEF_UP_2
	const EFFECT_ACCURACY_UP_2
	const EFFECT_EVASION_UP_2
	const EFFECT_TRANSFORM
	const EFFECT_OFFENSES_DOWN_2  ; EFFECT_ATTACK_DOWN_2
	const EFFECT_DEFENSES_DOWN_2  ; EFFECT_DEFENSE_DOWN_2
	const EFFECT_SPEED_DOWN_2
	const_skip  ; EFFECT_SP_ATK_DOWN_2
	const_skip  ; EFFECT_SP_DEF_DOWN_2
	const EFFECT_ACCURACY_DOWN_2
	const EFFECT_EVASION_DOWN_2
	const EFFECT_REFLECT
	const EFFECT_POISON
	const EFFECT_PARALYZE
	const EFFECT_OFFENSES_DOWN_HIT  ; EFFECT_ATTACK_DOWN_HIT
	const EFFECT_DEFENSES_DOWN_HIT  ; EFFECT_DEFENSE_DOWN_HIT
	const EFFECT_SPEED_DOWN_HIT
	const_skip  ; EFFECT_SP_ATK_DOWN_HIT
	const_skip  ; EFFECT_SP_DEF_DOWN_HIT
	const EFFECT_ACCURACY_DOWN_HIT
	const EFFECT_EVASION_DOWN_HIT
	const_skip  ; SKY_ATTACK
	...
	const EFFECT_OFFENSES_UP_HIT  ; EFFECT_ATTACK_UP_HIT
	const EFFECT_DEFENSES_UP_HIT  ; EFFECT_DEFENSE_UP_HIT
	const EFFECT_ALL_UP_HIT
	const EFFECT_FAKE_OUT
	const EFFECT_BRN_RECOIL_HIT
